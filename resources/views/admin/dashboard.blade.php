...
<!-- Development Alert -->
<div class="mb-8 bg-amber-50 border border-amber-200 p-5 rounded-3xl flex items-center gap-4 shadow-sm">
    <div class="w-12 h-12 bg-amber-100 rounded-2xl flex items-center justify-center text-amber-600 shrink-0 animate-pulse">
        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
    </div>
    <div>
        <h4 class="font-bold text-amber-900 text-sm italic">Development Mode Active</h4>
        <p class="text-amber-700 text-xs mt-0.5 leading-relaxed">
            Admin Panel ini masih dalam tahap pengembangan. Beberapa fitur dan tampilan mungkin masih dalam proses perbaikan. Silakan laporkan jika Anda menemukan kendala saat mengoperasikan sistem.
        </p>
    </div>
</div>
